...
- [ ] ArgoCD root/platform app o trang thai `Synced` va `Healthy`.
- [ ] Web service phan hoi qua port-forward.
- [ ] Prometheus rule da ton tai hoac ghi chu vi sao local stack chua ho tro.
- [ ] Canary rollout dat trang thai healthy.
- [ ] Bad canary bi abort boi analysis.
- [ ] Ghi lai lenh rollback va giai thich vi sao rollback bang Git la uu tien.
